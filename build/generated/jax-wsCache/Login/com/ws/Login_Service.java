 ...
 * 
 */
@WebServiceClient(name = "Login", targetNamespace = "http://WS.com/", wsdlLocation = "http://localhost:8085/WEB_SERVICES/Login?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGIN_QNAME = new QName("http://WS.com/", "Login");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8085/WEB_SERVICES/Login?wsdl");
    ...
    public Login getLoginPort() {
        return super.getPort(new QName("http://WS.com/", "LoginPort"), Login.class);
    }
    ...
    public Login getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WS.com/", "LoginPort"), Login.class, features);
    }
